...
class BookmarksApi {
  ...
  Future<List<BookmarksModel>> getAllBookmarks() async {
    try {
      ...
      if (response.statusCode.toString().startsWith("2")) {
        ...
        List<BookmarksModel> allFolders = List.from(
          folder ?? [],
  ...
  /// create new folder
  Future<CreateBookmarksModel> createBookmark({
    required CreateBookmarksModel inputData,
  }) async {
    try {
      var url = Uri.parse(
        _constant.baseURL + _constant.createBookmarksEndPoint,
      );
  ...
  Future<List<BookmarksModel>> getBookmarksByFolder({
    required String id,
  }) async {
    try {
      var url = Uri.parse(
  ...
  ///update folder
  Future<UpdateBookmarksModel> updateBookmarks({
    //required String id,
